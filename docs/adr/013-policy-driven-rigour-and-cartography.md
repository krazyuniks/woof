...
Rigour is data and policy driven. Repo policy declares the gate/check floor and cartography floor. Epic content and work-unit trace fields activate the relevant checks. The engine path remains one loop over `work_units[]`.
