...
| `cartography-structural-query-result.schema.json` | `woof cartography ... --json` query results |
| `cartography-search-result.schema.json` | Future semantic-retrieval query results |
