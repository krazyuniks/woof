...
work_units:
  ...
  - id: vaultforeman-fix-parity
    ...
    acceptance:
      ...
      - The runner-asset source map is refreshed to the pinned VaultForeman engine-repo commit recorded when this unit is decomposed, and marked historical once parity lands.
  ...
  - id: vaultforeman-retirement
    ...
    acceptance:
      ...
      - A final VaultForeman delta sweep runs from the recorded fix-parity pin to the VaultForeman tip at retirement time, and every behavioural fix in that window is carried, consciously superseded, or recorded as not-applicable before the standalone runner is removed.
...
|---|---|---|---|
| 0 | Runner-asset source map | done | Source map is in `~/Work/radianit-vault/projects/woof/planning/runner-asset-source-map.md`. |
