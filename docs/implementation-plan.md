...
Start with:
Workstream F: Stage 1-4 graph migration (`STG-001`, `STG-002`, `STG-003`, `STG-004`, `STG-005`). Workstream R is complete. Finish any item already `In progress`; otherwise start with `STG-003`.
```
