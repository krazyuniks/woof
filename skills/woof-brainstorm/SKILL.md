...
<!-- GENERATED by scripts/gen_woof_brainstorm.py from agent-toolkit skills/brainstorm @ 4c89fc1c35569b752cc3b4d52d352455ab080cb7. The 'Wrapper' section is woof-owned; the block between the BEGIN/END VENDORED markers is the canonical body, pinned and drift-checked against VENDOR.json. Do not edit by hand - regenerate with `just gen-brainstorm`. -->
